...
export const getRootMeta: MetaFunction = ({ data }) => {
  const title = 'LuDo-Chi';
  const description = 'Donat & Mochi Bread yang Bikin Kamu Senyum 🍩. Dibuat dengan cinta, disajikan dengan hangat.';
  const ogTitle = title;
    ...
    <RootProviders>
      <html lang="en" className="min-h-screen">
        <head ref={headRef}>
          ...
          <link
            href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;1,300;1,400;1,500;1,600&family=Crimson+Pro:ital,wght@0,400;0,600;1,400;1,600&family=Cinzel:wght@400;500;600;700&display=swap"
            rel="stylesheet"
          />
          <Links />
